...
<br>
  ...
  <div class="column">
                                                    ...
                                                    <div class="field">
                                                      ...
                                                      <div class="control">
                                                        <input id="cuenta" name="cuenta" class="input" type="text" value="<?php echo $user; ?>" disabled>
                                                      </div>
                                                    </div>
...
<script>
  ...
  $.ajax({
                    ...
                    data: {cuenta:$("#cuenta").val(),newpass:$("#newpass").val()},
                    dataType: 'json'
                })
       ...
       if (com3==""){
            ...
            $("#cancelar").click(function() {
                                                ...
                                                swal("¿Deseas cancelar el cambio de contraseña?", {
                                                buttons: {
                                                  cancel: "Cancelar!",
                                                  catch: {
                                                    text: "Regresar a SEA",
